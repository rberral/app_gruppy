...
%>
    ...
    <script src="lib/startbootstrap-sb-admin-gh-pages/js/plugins/flot/jquery.flot.js"></script>
    <script src="lib/startbootstrap-sb-admin-gh-pages/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="lib/startbootstrap-sb-admin-gh-pages/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="lib/startbootstrap-sb-admin-gh-pages/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="lib/startbootstrap-sb-admin-gh-pages/js/plugins/flot/flot-data.js"></script>
	<!-- Load NavBar Left -->
