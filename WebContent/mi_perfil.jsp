...
<div class="form-group row">
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
    <input  name="fecha_nac" placeholder="AAAA/MM/DD" class="form-control"  type="datetime" maxlength="10" value="<%= Utilidades.getFechaToJSP(p.getFechaNacimiento()) %>">
    </div>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
    <input  name="fecha_alta" placeholder="AAAA/MM/DD" class="form-control"  type="datetime" value="<%= Utilidades.getFechaToJSP(p.getFechaAlta()) %>" disabled>
    </div>
  </div>
</div>
